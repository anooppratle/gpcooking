    ...
    <div>
      ...
      >
        ...
        >
          ...
          {/* Medium Circle */}
          <div
            className="absolute inset-[220px] border border-orange-500/20 rounded-full"
            style={{ transform: `rotate(${-rotation * 1.5}deg)` }}
          />

          {/* Small Circle */}
          <div
            className="absolute inset-[337px] border border-orange-500/20 rounded-full"
          ...
          <div
            ...
            style={{
              top: "50%",
              left: "50%",
              transform: `rotate(${-rotation * 1.5}deg) translate(340px) rotate(${rotation * 
                1.5}deg)`,
            }}
          />
          <div
            ...
            style={{
              top: "50%",
              left: "50%",
              transform: `rotate(${rotation * 2}deg) translate(230px) rotate(-${rotation *
                2}deg)`,
            }}
          />
        </div>
